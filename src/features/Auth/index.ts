...
export { validatePassword } from './model/services/validatePassword/validatePassword';
export { ValidateRegistrationPasswordError } from './model/types/registrationSchema';
